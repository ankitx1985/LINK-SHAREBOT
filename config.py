...
DB_NAME = os.environ.get("DB_NAME", "HbBots")
TG_BOT_WORKERS = int(os.environ.get("TG_BOT_WORKERS", "200"))
COMMAND_PHOTO = os.environ.get("COMMAND_PHOTO", "https://telegra.ph/Extractor-Bot-08-25")  # Replace with your photo URL
START_PIC = os.environ.get("START_PIC", "https://telegra.ph/Extractor-Bot-08-25")
...
ABOUT_TXT = os.environ.get("HELP_MESSAGE", "<i><b><blockquote>◈ ᴄʀᴇᴀᴛᴏʀ: <a href=https://t.me/Heisenbergsells>Heisenberg</a>\n◈ ꜰᴏᴜɴᴅᴇʀ ᴏꜰ : <a href=https://t.me/HeisenbergUniverse>Heisenberg Universe</a>\n◈ ᴅᴇᴠᴇʟᴏᴘᴇʀ: <a href='https://t.me/Heisenbergsells'>Heisenberg</a>\n◈ ᴅᴀᴛᴀʙᴀsᴇ: <a href='https://www.mongodb.com/docs/'>ᴍᴏɴɢᴏ ᴅʙ</a>\n» ᴅᴇᴠᴇʟᴏᴘᴇʀ: <a href='https://t.me/Heisenbergsells'>Heisenberg</a></blockquote></b></i>")
...
FSUB_PIC = os.environ.get("FSUB_PIC", "https://telegra.ph/Extractor-Bot-08-25")
FSUB_LINK_EXPIRY = 0
